...
# Disclaimer
This is a free software which comes with an open source license. Although the author has tried to make it working correctly, it may still contai defects, and in such case the author is not in any way responsible for the incorrect results generated by this software. It should not be used for financial statement calculations or any other use cases in which the data provided by the software might cause financial or legal consequences. It is just for example purpose and you use it on your own risk. In case you need your data to be accurate, I advice you to seek other tools, or to double check the output of the program against the official NBP website. And if you find an issue with this software - please either fix it, or report it.
